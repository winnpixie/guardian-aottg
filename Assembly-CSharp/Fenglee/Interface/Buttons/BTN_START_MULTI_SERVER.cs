...
public class BTN_START_MULTI_SERVER : MonoBehaviour
{
    private void OnClick()
    {
        ...
        string difficulty = GameObject.Find("CheckboxHard").GetComponent<UICheckbox>().isChecked ? "hard"
            : ((!GameObject.Find("CheckboxAbnormal").GetComponent<UICheckbox>().isChecked) ? "normal" : "abnormal");
        ...
        name
            ...
            + "`" + daylight
            + "`" + password
            + "`" + Guardian.Utilities.MathHelper.RandInt(int.MinValue, int.MaxValue);
