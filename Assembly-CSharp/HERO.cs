...
public class HERO : Photon.MonoBehaviour
{
    ...
    {
        if (useGun && !grounded && FengGameManagerMKII.CurrentLevelInfo.type == GAMEMODE.PVP_AHSS)
        {
            return;
        }
    ...
    private void Start()
    {
        ...
        if ((FengGameManagerMKII.CurrentLevelInfo.horse || RCSettings.HorseMode == 1) && IN_GAME_MAIN_CAMERA.Gametype == GAMETYPE.MULTIPLAYER && base.photonView.isMine)
        {
    ...
    private void showAimUI2()
    {
        ...
        {
            GameObject gameObject = cross1;
            GameObject gameObject2 = cross2;
            GameObject gameObject3 = crossL1;
            GameObject gameObject4 = crossL2;
            GameObject gameObject5 = crossR1;
            GameObject gameObject6 = crossR2;
        ...
        GameObject gameObject7 = cross1;
        GameObject gameObject8 = cross2;
        gameObject7.transform.localPosition = Input.mousePosition;
        gameObject7.transform.localPosition -= new Vector3((float)Screen.width * 0.5f, (float)Screen.height * 0.5f, 0f);
        ...
        if (magnitude > 120f)
        {
            gameObject7.transform.localPosition += Vector3.up * 10000f;
            labelDistance2.transform.localPosition = gameObject8.transform.localPosition;
        }
        else
        {
            gameObject8.transform.localPosition += Vector3.up * 10000f;
            labelDistance2.transform.localPosition = gameObject7.transform.localPosition;
        }
            ...
            switch (state)
            {
                case HERO_STATE.Idle:
                    ...
                    if (useGun)
                    {
                        ...
                        else if (flag4 && (grounded || (FengGameManagerMKII.CurrentLevelInfo.type != GAMEMODE.PVP_AHSS && RCSettings.AhssReload == 0)))
                        {
                            changeBlade();
                        }
                    }
    ...
    public void setStat2()
    {
        ...
        switch (skillId)
        {
            ...
            case "eren":
                ...
                if (IN_GAME_MAIN_CAMERA.Gametype == GAMETYPE.MULTIPLAYER)
                {
                    if (FengGameManagerMKII.CurrentLevelInfo.teamTitan || FengGameManagerMKII.CurrentLevelInfo.type == GAMEMODE.RACING || FengGameManagerMKII.CurrentLevelInfo.type == GAMEMODE.PVP_CAPTURE || FengGameManagerMKII.CurrentLevelInfo.type == GAMEMODE.TROST)
                    {
                        skillId = "petra";
                        skillCDLast = 1f;
                    }
    ...
    public void netDieLocal(Vector3 v, bool isBite, int viewID = -1, string titanName = "", bool killByTitan = true)
    {
        ...
        if (base.photonView.isMine)
        {
            ...
            {
                FengGameManagerMKII.Instance.sendKillInfo(!(titanName == string.Empty), titanName, isVictimTitan: false, GExtensions.AsString(PhotonNetwork.player.customProperties[PhotonPlayerProperty.Name]));
            }
        }
        if (base.photonView.isMine)
        {
    ...
    public IEnumerator LoadSkinE(int horse, string url)
    {
        ...
        if (FengGameManagerMKII.CurrentLevelInfo.horse || RCSettings.HorseMode == 1)
        {
            flaghorse = true;
        }
        ...
        if (setup.part_hair_1 != null)
        {
            ...
            if (strArray[1].EndsWith(".jpg") || strArray[1].EndsWith(".png") || strArray[1].EndsWith(".jpeg"))
            {
                ...
                {
                    WWW link2 = GameHelper.CreateWWW(strArray[1]);
                    if (link2 != null)
                    {
                        yield return link2;
        ...
        if (setup.part_cape != null)
        {
            ...
            if (strArray[7].EndsWith(".jpg") || strArray[7].EndsWith(".png") || strArray[7].EndsWith(".jpeg"))
            {
                ...
                {
                    WWW link3 = GameHelper.CreateWWW(strArray[7]);
                    if (link3 != null)
                    {
                        yield return link3;
        ...
        if (setup.part_chest_3 != null)
        {
            ...
            if (strArray[6].EndsWith(".jpg") || strArray[6].EndsWith(".png") || strArray[6].EndsWith(".jpeg"))
            {
                ...
                {
                    WWW link4 = GameHelper.CreateWWW(strArray[6]);
                    if (link4 != null)
                    {
                        yield return link4;
            ...
            foreach (Renderer renderer4 in componentsInChildren)
            {
                if (renderer4.name.Contains(FengGameManagerMKII.S[1]))
                {
                    if (strArray[1].EndsWith(".jpg") || strArray[1].EndsWith(".png") || strArray[1].EndsWith(".jpeg"))
                    {
                        if (!FengGameManagerMKII.LinkHash[0].ContainsKey(strArray[1]))
                        {
                            WWW link5 = GameHelper.CreateWWW(strArray[1]);
                            if (link5 != null)
                            {
                                yield return link5;
                ...
                else if (renderer4.name.Contains(FengGameManagerMKII.S[2]))
                {
                    if (strArray[2].EndsWith(".jpg") || strArray[2].EndsWith(".png") || strArray[2].EndsWith(".jpeg"))
                    {
                        ...
                        {
                            WWW link6 = GameHelper.CreateWWW(strArray[2]);
                            if (link6 != null)
                            {
                                yield return link6;
                ...
                else if (renderer4.name.Contains(FengGameManagerMKII.S[3]))
                {
                    if (strArray[3].EndsWith(".jpg") || strArray[3].EndsWith(".png") || strArray[3].EndsWith(".jpeg"))
                    {
                        ...
                        {
                            WWW link7 = GameHelper.CreateWWW(strArray[3]);
                            if (link7 != null)
                            {
                                yield return link7;
                ...
                else if (renderer4.name.Contains(FengGameManagerMKII.S[4]))
                {
                    if (strArray[4].EndsWith(".jpg") || strArray[4].EndsWith(".png") || strArray[4].EndsWith(".jpeg"))
                    {
                        ...
                        {
                            WWW link8 = GameHelper.CreateWWW(strArray[4]);
                            if (link8 != null)
                            {
                                yield return link8;
                ...
                else if (renderer4.name.Contains(FengGameManagerMKII.S[5]) || renderer4.name.Contains(FengGameManagerMKII.S[6]) || renderer4.name.Contains(FengGameManagerMKII.S[10]))
                {
                    if (strArray[5].EndsWith(".jpg") || strArray[5].EndsWith(".png") || strArray[5].EndsWith(".jpeg"))
                    {
                        ...
                        {
                            WWW link16 = GameHelper.CreateWWW(strArray[5]);
                            if (link16 != null)
                            {
                                yield return link16;
                ...
                else if (renderer4.name.Contains(FengGameManagerMKII.S[7]) || renderer4.name.Contains(FengGameManagerMKII.S[8]) || renderer4.name.Contains(FengGameManagerMKII.S[9]) || renderer4.name.Contains(FengGameManagerMKII.S[24]))
                {
                    if (strArray[6].EndsWith(".jpg") || strArray[6].EndsWith(".png") || strArray[6].EndsWith(".jpeg"))
                    {
                        if (!FengGameManagerMKII.LinkHash[1].ContainsKey(strArray[6]))
                        {
                            WWW link15 = GameHelper.CreateWWW(strArray[6]);
                            if (link15 != null)
                            {
                                yield return link15;
                ...
                else if (renderer4.name.Contains(FengGameManagerMKII.S[11]) || renderer4.name.Contains(FengGameManagerMKII.S[12]))
                {
                    if (strArray[7].EndsWith(".jpg") || strArray[7].EndsWith(".png") || strArray[7].EndsWith(".jpeg"))
                    {
                        if (!FengGameManagerMKII.LinkHash[0].ContainsKey(strArray[7]))
                        {
                            WWW link14 = GameHelper.CreateWWW(strArray[7]);
                            if (link14 != null)
                            {
                                yield return link14;
                ...
                else if (renderer4.name.Contains(FengGameManagerMKII.S[15]) || ((renderer4.name.Contains(FengGameManagerMKII.S[13]) || renderer4.name.Contains(FengGameManagerMKII.S[26])) && !renderer4.name.Contains("_r")))
                {
                    if (strArray[8].EndsWith(".jpg") || strArray[8].EndsWith(".png") || strArray[8].EndsWith(".jpeg"))
                    {
                        ...
                        {
                            WWW link13 = GameHelper.CreateWWW(strArray[8]);
                            if (link13 != null)
                            {
                                yield return link13;
                ...
                else if (renderer4.name.Contains(FengGameManagerMKII.S[17]) || renderer4.name.Contains(FengGameManagerMKII.S[16]) || (renderer4.name.Contains(FengGameManagerMKII.S[26]) && renderer4.name.Contains("_r")))
                {
                    if (strArray[9].EndsWith(".jpg") || strArray[9].EndsWith(".png") || strArray[9].EndsWith(".jpeg"))
                    {
                        ...
                        {
                            WWW link12 = GameHelper.CreateWWW(strArray[9]);
                            if (link12 != null)
                            {
                                yield return link12;
                ...
                else if (renderer4.name == FengGameManagerMKII.S[18] && flaggas)
                {
                    if (strArray[10].EndsWith(".jpg") || strArray[10].EndsWith(".png") || strArray[10].EndsWith(".jpeg"))
                    {
                        ...
                        {
                            WWW link11 = GameHelper.CreateWWW(strArray[10]);
                            if (link11 != null)
                            {
                                yield return link11;
                ...
                else if (renderer4.name.Contains(FengGameManagerMKII.S[25]))
                {
                    if (strArray[11].EndsWith(".jpg") || strArray[11].EndsWith(".png") || strArray[11].EndsWith(".jpeg"))
                    {
                        ...
                        {
                            WWW link10 = GameHelper.CreateWWW(strArray[11]);
                            if (link10 != null)
                            {
                                yield return link10;
                    ...
                    foreach (Renderer renderer5 in componentsInChildren2)
                    {
                        if (renderer5.name.Contains(FengGameManagerMKII.S[19]))
                        {
                            if (strArray[0].EndsWith(".jpg") || strArray[0].EndsWith(".png") || strArray[0].EndsWith(".jpeg"))
                            {
                                ...
                                {
                                    WWW link9 = GameHelper.CreateWWW(strArray[0]);
                                    if (link9 != null)
                                    {
                                        yield return link9;
        ...
        if (flagtrail && (strArray[12].EndsWith(".jpg") || strArray[12].EndsWith(".png") || strArray[12].EndsWith(".jpeg")))
        {
            ...
            {
                WWW link = GameHelper.CreateWWW(strArray[12]);
                if (link != null)
                {
                    yield return link;
