...
internal class NetworkingPeer : LoadbalancingPeer, IPhotonPeerListener
{
    ...
    public virtual bool OpLeave()
    {
        ...
        return OpCustom(OperationCode.Leave, null, sendReliable: true, 0);
    }
    ...
    public void ExecuteRPC(ExitGames.Client.Photon.Hashtable rpcData, PhotonPlayer sender)
    {
        ...
        if (rpcData.ContainsKey((byte)0x5))
        {
            int rpcIndex = (byte)rpcData[(byte)0x5];
        ...
        {
            rpcName = (string)rpcData[(byte)0x3];
        }

        object[] parameters = new object[0];
        if (rpcData.ContainsKey((byte)0x4))
        {
            parameters = (object[])rpcData[(byte)0x4] ?? new object[0];
        }
    ...
    public void OnEvent(EventData photonEvent)
    {
        ...
        switch (photonEvent.Code)
        {
            ...
            case EventCode.AppStats:
                {
                    object obj2 = photonEvent[229];
                    object obj3 = photonEvent[227];
                    object obj4 = photonEvent[228];
            ...
            case EventCode.Leave:
                HandleEventLeave(actorNr);
                break;
            case EventCode.Join:
                {
                    object obj5 = photonEvent[249];
            ...
            case EventCode.ErrorInfo:
                {
                    object obj = photonEvent[ParameterCode.Info];
                    if (obj != null && obj is string)
                    {
                        Mod.Logger.Error((string)obj);
                    }
                    break;
                }
            case 101: // Cyan Mod
