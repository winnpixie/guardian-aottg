...
public class MicGUI : MonoBehaviour
{
    ...
    {
        float desiredWidth = 1920f; // Theoretically makes 4K screens still look okay (may need to change some other things though)
        ...
        float width = desiredWidth / 4.2f;
        float height = desiredHeight / 4.2f;
