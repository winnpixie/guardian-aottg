...
public class UIStretch : MonoBehaviour
{
	...
	private void Update()
	{
		...
		else if (widgetContainer != null)
		{
			...
			vector2.y -= 1f;
			float x = vector2.x;
			Vector2 vector3 = widgetContainer.relativeSize;
			vector2.x = x * (vector3.x * localScale.x);
			float y = vector2.y;
			Vector2 vector4 = widgetContainer.relativeSize;
			vector2.y = y * (vector4.y * localScale.y);
