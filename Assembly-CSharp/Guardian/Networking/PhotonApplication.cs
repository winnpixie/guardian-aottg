namespace Guardian.Networking
{
    public class PhotonApplication
    {
        ...
        public static PhotonApplication Guardian =
            new PhotonApplication("Guardian", "b92ae2ae-b815-4f37-806a-58b4f58573ff", 1);

        public static PhotonApplication Custom = new PhotonApplication("Custom", string.Empty, 2);

        public static PhotonApplication AoTSkins =
            new PhotonApplication("AoT Skins", "b3d7a26b-9163-40ed-8253-41a6ee764195", 3);
