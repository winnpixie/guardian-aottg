...
public class UISprite : UIWidget
{
	...
	public override Vector4 border
	{
		get
		{
			if (type == Type.Sliced)
			{
				...
				{
					rect = NGUIMath.ConvertToPixels(rect, mainTexture.width, mainTexture.height, round: true);
					rect2 = NGUIMath.ConvertToPixels(rect2, mainTexture.width, mainTexture.height, round: true);
				}
	...
	public override bool pixelPerfectAfterResize => type == Type.Sliced;
	...
	public override void MakePixelPerfect()
	{
		...
		if (mainTexture != null)
		{
			Rect rect = NGUIMath.ConvertToPixels(outerUV, mainTexture.width, mainTexture.height, round: true);
